...
const Header = () => {
    ...
    const favoriteCount = useSelector((state => state.favorite.favorite.length))


    const cart = <  svg className='header__cart' xmlns="http://www.w3.org/2000/svg" width="30px" height="30px"
    ...
    const favorite = <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
        <path fill='#ffaa00'
        ...
        <header className='header' >
            <nav className='header__nav' >
                <ul className='header__nav--list'>
                    <li className='header__home--item'>
                        <NavLink className='header__store--link' to="/"> Store </NavLink>
                    </li>
                    <li className='header__cart--item'>
                        <NavLink className='header__cart--link' to="/cart">{cart}{cartCount}</NavLink>
                    </li>
                    <li className='header__favorite--item'>
                        <NavLink className='header__favorite--link' to="/favorite" >{favorite}{favoriteCount}</NavLink>
                    </li>
                </ul>
            </nav>
        </header>
